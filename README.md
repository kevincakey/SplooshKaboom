...
>* Iterator: The iterator design pattern will detect whether a fired cannonball hit or miss a squid. Status of the tile, from Factory Method, will be determined by the iterator. Value of hit or miss will change tile's status of untouched to another value. Untouched=0, hit=1, miss=2.ssad
